...
> `plyr` is an attempt to organize much of the functionality of the `*apply` family of methods in R. Some of these methods are superseded by dplyr and plyr, but [they remain useful](https://stackoverflow.com/questions/3505701/grouping-functions-tapply-by-aggregate-and-the-apply-family).
